...
$mysqli=mysqli_connect("localhost","root","", "proyectojp");
    ...
    class Conectar{
        ...
        protected function Conexion(){
            try {
				...
				$conectar = $this->dbh = new PDO("mysql:local=localhost;dbname=proyectojp","root","");
        ...
        public static function ruta(){
            //ruta del proyecto
            return "http://localhost/proyectojpV2/";
        }
